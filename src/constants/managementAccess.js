...
export const MANAGEMENT_AREA_BY_PERMISSION = Object.freeze({
    ...
    [PERMISSIONS.INVENTORY_VIEW]: MANAGEMENT_ACCESS_AREAS.INVENTORY,
    [PERMISSIONS.INVENTORY_MANAGE]: MANAGEMENT_ACCESS_AREAS.INVENTORY,
    [PERMISSIONS.INVENTORY_RECEIVE]: MANAGEMENT_ACCESS_AREAS.INVENTORY,
    [PERMISSIONS.INVENTORY_WASTE]: MANAGEMENT_ACCESS_AREAS.INVENTORY,
    [PERMISSIONS.INVENTORY_ADJUST]: MANAGEMENT_ACCESS_AREAS.INVENTORY,
    [PERMISSIONS.INVENTORY_RECIPE_MANAGE]: MANAGEMENT_ACCESS_AREAS.INVENTORY,
    [PERMISSIONS.INVENTORY_ROOM_USAGE_RECORD]: MANAGEMENT_ACCESS_AREAS.INVENTORY,
    [PERMISSIONS.HOUSEKEEPING_VIEW]: MANAGEMENT_ACCESS_AREAS.HOUSEKEEPING,
    [PERMISSIONS.HOUSEKEEPING_PERFORM]: MANAGEMENT_ACCESS_AREAS.HOUSEKEEPING,
    [PERMISSIONS.HOUSEKEEPING_ASSIGN]: MANAGEMENT_ACCESS_AREAS.HOUSEKEEPING,
    [PERMISSIONS.HOUSEKEEPING_MANAGE]: MANAGEMENT_ACCESS_AREAS.HOUSEKEEPING,
