export const PERMISSIONS = Object.freeze({
    ...
    INVENTORY_ROOM_USAGE_RECORD: "inventory.roomUsage.record",
...
export const PERMISSION_DEPENDENCIES = Object.freeze({
    ...
    [PERMISSIONS.HOUSEKEEPING_PERFORM]: [PERMISSIONS.HOUSEKEEPING_VIEW],
    [PERMISSIONS.HOUSEKEEPING_ASSIGN]: [PERMISSIONS.HOUSEKEEPING_VIEW],
    [PERMISSIONS.HOUSEKEEPING_MANAGE]: [PERMISSIONS.HOUSEKEEPING_VIEW],
    [PERMISSIONS.SERVICE_POINTS_MANAGE]: [PERMISSIONS.SERVICE_POINTS_VIEW],
    [PERMISSIONS.STAFF_MANAGE]: [PERMISSIONS.STAFF_VIEW],
})

export const HOUSEKEEPING_DEFAULT_PERMISSIONS = Object.freeze([
